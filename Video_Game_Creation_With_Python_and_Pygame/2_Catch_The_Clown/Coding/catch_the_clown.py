...
clown_dx = random.choice([-1, 1])  # delta x, change in the x-direction
clown_dy = random.choice([-1, 1])  # delta y, change in the y-direction
...
# Set fonts
font = pygame.font.Font("2_Catch_the_Clown/Fonts/Franxurter.ttf", 32)
...
# Set sound and music
click_sound = pygame.mixer.Sound("2_Catch_the_Clown/Sounds/click_sound.wav")
miss_sound = pygame.mixer.Sound("2_Catch_the_Clown/Sounds/miss_sound.wav")
pygame.mixer.music.load("2_Catch_the_Clown/Sounds/ctc_background_music.wav")

# Set images
background_image = pygame.image.load("2_Catch_the_Clown/Images/background.png")
background_rect = background_image.get_rect()
background_rect.topleft = (0, 0)

clown_image = pygame.image.load("2_Catch_the_Clown/Images/clown.png")
