...
continue_text = font.render(
    "Press any key to play again", True, RED, DARKGREEN)
continue_rect = continue_text.get_rect()
continue_rect.center = (WINDOW_WIDTH//2, WINDOW_HEIGHT//2 + 64)

# Set sounds and music
pick_up_sound = pygame.mixer.Sound("3_Snake/Sounds/pick_up_sound.wav")
...
while running:
    ...
    if head_rect.colliderect(apple_rect):
        ...
        # Re-allocate the apple to a different location on screen, after collision
