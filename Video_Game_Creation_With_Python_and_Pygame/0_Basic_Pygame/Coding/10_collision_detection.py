...
coin_image = pygame.image.load("0_Basic_Pygame/Images/coin.png")
...
while running:
    ...
    if dragon_rect.colliderect(coin_rect):
        print("HIT")
        # Coin image is 32 pixels big, thus -32
        coin_rect.x = random.randint(0, WINDOW_WIDTH - 32)  # left
        coin_rect.y = random.randint(0, WINDOW_HEIGHT - 32)  # top
...
"""
    Coin image:
        Backlink to http://awicons.com required
"""
