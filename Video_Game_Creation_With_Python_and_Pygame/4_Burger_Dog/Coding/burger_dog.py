...
# Set fonts
font = pygame.font.Font("4_Burger_Dog/Fonts/WashYourHand.ttf", 32)
...
bark_sound = pygame.mixer.Sound("4_Burger_Dog/Sounds/bark_sound.wav")
miss_sound = pygame.mixer.Sound("4_Burger_Dog/Sounds/miss_sound.wav")
pygame.mixer.music.load("4_Burger_Dog/Sounds/bd_background_music.wav")

# Set images
player_image_right = pygame.image.load("4_Burger_Dog/Images/dog_right.png")
player_image_left = pygame.image.load("4_Burger_Dog/Images/dog_left.png")
...
burger_image = pygame.image.load("4_Burger_Dog/Images/burger.png")
...
while running:
    ...
    if player_lives == 0:
        game_over_text = font.render(
            "FINAL SCORE: " + str(score), True, ORANGE)
