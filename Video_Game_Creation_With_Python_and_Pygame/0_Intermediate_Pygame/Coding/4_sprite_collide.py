...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, monster_group):
        ...
        self.image = pygame.image.load(
            "0_Intermediate_Pygame/Images/knight.png")
    ...
    def check_collisions(self):
        ...
        # True (third element of 'spritecollide') -->
        # the item within the group that is collided with will be destroyed
...
class Monster(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load(
            "0_Intermediate_Pygame/Images/blue_monster.png")
        self.rect = self.image.get_rect()
        self.rect.topleft = (x, y)
...
"""
Backlink to image (blue_monster):  
