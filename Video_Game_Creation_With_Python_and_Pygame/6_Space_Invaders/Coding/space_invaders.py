...
class Game():
    ...
    def __init__(self, player, alien_group, player_bullet_group, alien_bullet_group):
        ...
        self.new_round_sound = pygame.mixer.Sound(
            "6_Space_Invaders/Sounds/new_round.wav")
        self.breach_sound = pygame.mixer.Sound(
            "6_Space_Invaders/Sounds/breach.wav")
        self.alien_hit_sound = pygame.mixer.Sound(
            "6_Space_Invaders/Sounds/alien_hit.wav")
        self.player_hit_sound = pygame.mixer.Sound(
            "6_Space_Invaders/Sounds/player_hit.wav")

        # Set font
        self.font = pygame.font.Font("6_Space_Invaders/Fonts/Facon.ttf", 32)
    ...
    def check_collisions(self):
        ...
        if pygame.sprite.spritecollide(self.player, self.alien_bullet_group, True):
            ...
            self.check_game_status(
                "You've been hit!", "Press 'Enter' to continue")
    ...
    def start_new_round(self):
        ...
        self.pause_game("Space Invaders Round " +
                        str(self.round_number), "Press 'Enter' to begin")

    def check_game_status(self, main_text, sub_text):
        """ Check to see the status of the game and how the player died. """
        # Empty the bullet groups, reset player and remaining aliens
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, bullet_group):
        ...
        self.image = pygame.image.load(
            "6_Space_Invaders/Images/player_ship.png")
        ...
        self.shoot_sound = pygame.mixer.Sound(
            "6_Space_Invaders/Sounds/player_fire.wav")
...
class Alien(pygame.sprite.Sprite):
    """ A class to model an an emeny alien. """

    def __init__(self, x, y, velocity, bullet_group):
        """ Initialize the alien. """
        super().__init__()

        self.image = pygame.image.load("6_Space_Invaders/Images/alien.png")
        self.rect = self.image.get_rect()
        ...
        self.shoot_sound = pygame.mixer.Sound(
            "6_Space_Invaders/Sounds/alien_fire.wav")
    ...
    def fire(self):
        """ Fire a bullet. """
        AllienBullet(self.rect.centerx, self.rect.bottom, self.bullet_group)
...
class PlayerBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, bullet_group):
        ...
        self.image = pygame.image.load(
            "6_Space_Invaders/Images/green_laser.png")
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.centery = y
...
class AllienBullet(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, bullet_group):
        ...
        self.image = pygame.image.load("6_Space_Invaders/Images/red_laser.png")
        self.rect = self.image.get_rect()
        self.rect.centerx = x
        self.rect.centery = y
...
my_game = Game(my_player, my_alien_group,
               my_player_bullet_group, my_alien_bullet_group)
